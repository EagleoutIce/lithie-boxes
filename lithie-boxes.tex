...
% TODO: restyle signature:
% \begin{definition}(optional tcolorbox args)[refname]{name}
% so we can make them 'float*' and stuff.
...
\edef\libx@boxid{#2}%
\begin{environment}{\@nameuse{@libx@#1@envname}}{\optArg{Referenztitel}\manArg{Titel}}
