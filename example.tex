...
\usepackage{microtype,blindtext,wrapfig}
...
\begin{document}
\begin{figure*}
    \begin{definition}{Ich schwebe, Mammi.  Hallo welt wie geht es dir dies ist ein Wort wie du mir so cih ir ist das nicht toll das ist fabehlaft. Ich trage fabeltracht.}
